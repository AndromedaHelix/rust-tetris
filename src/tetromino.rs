...
pub mod line {
    ...
    use super::characters::TetrominoCharacter;
            ...
            match rotation {
                90 => match self.shape_type {
                    ...
                    4 => {
                        ...
                        self.first_line = Line::new(self.first_line.x, self.first_line.y, 1);
                        self.second_line =
                            Line::new(self.first_line.x - 1, self.first_line.y + 1, 2);
                        self.third_line =
                            Line::new(self.first_line.x - 1, self.first_line.y + 2, 1);
                    }
                    5 => {
                        self.clear();
                ...
                180 => match self.shape_type {
                    ...
                    5 => {
                        ...
                        self.first_line = Line::new(self.first_line.x, self.first_line.y, 1);
                        self.second_line =
                            Line::new(self.first_line.x - 1, self.first_line.y + 1, 3);
                    }
                    _ => {}
                },
                ...
                0 => match self.shape_type {
                    ...
                    2 => {
                        ...
                        self.second_line =
                            Line::new(self.first_line.x + 2, self.first_line.y + 1, 1);
                    }
                    4 => {
                        self.clear();
                    ...
                    5 => {
                        ...
                        self.second_line =
                            Line::new(self.first_line.x + 1, self.first_line.y + 1, 1);
                    }
                    _ => {}
                },
                _ => {}
